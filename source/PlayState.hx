...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Leave.', 0.2], //From 0% to 19%
		['Quit already.', 0.4], //From 20% to 39%
		['Bad!', 0.5], //From 40% to 49%
		['Could be better.', 0.6], //From 50% to 59%
		['Meh!', 0.69], //From 60% to 68%
		['Yum!', 0.7], //69%
		['Heat!', 0.8], //From 70% to 79%
		['Hot in here!', 0.9], //From 80% to 89%
		['Master Cook!', 1], //From 90% to 99%
		['Master Cook!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'hellskitchen':
				...
				var bg:BGSprite = new BGSprite('stages/hellskitchen/hellskitchen1', 0, 0, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 0.8));				
				bg.updateHitbox();
				add(bg);	

				var bg:BGSprite = new BGSprite('stages/hellskitchen/hellskitchen2', 0, 0, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				bg.updateHitbox();
				add(bg);	
				...
				var bg:BGSprite = new BGSprite('stages/hellskitchen/hellskitchen3', 0, 0, 0.9, 0.9);
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				bg.updateHitbox();
				add(bg);	
